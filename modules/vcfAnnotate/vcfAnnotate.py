...
with open(argv[3], "a+") as pipeTARGET:
    pipeTARGET.write(
        ...
        '#pairTXT:          expand("{outputDIR}/{vcfAnnotateDIR}/tables/{sample[1][tumor]}_{sample[1][normal]}.{vcfProgram}.{form[1][varType]}{form[1][annotated]}.txt", outputDIR=config["outputDIR"], vcfAnnotateDIR=config["vcfAnnotateDIR"], sample=read_table(config["sampleFILE"], " ").iterrows(), vcfProgram=config["vcfProgram"], form=read_table(StringIO(config["sampleFORM"]), " ").iterrows()),\n'
        '#pairALL:          expand("{outputDIR}/{vcfAnnotateDIR}/tables/all.samples.{vcfProgram}.{form[1][varType]}{form[1][annotated]}.txt", outputDIR=config["outputDIR"], vcfAnnotateDIR=config["vcfAnnotateDIR"], vcfProgram=config["vcfProgram"], form=read_table(StringIO(config["sampleFORM"]), " ").iterrows()),\n'
        ...
        '#singleTXT:        expand("{outputDIR}/{vcfAnnotateDIR}/tables/{samples}.{vcfProgram}.{form[1][varType]}{form[1][annotated]}.txt", outputDIR=config["outputDIR"], vcfAnnotateDIR=config["vcfAnnotateDIR"], samples=config["sample"], vcfProgram=config["vcfProgram"], form=read_table(StringIO(config["sampleFORM"]), " ").iterrows()),\n'
        '#singleALL:        expand("{outputDIR}/{vcfAnnotateDIR}/tables/all.samples.{vcfProgram}.{form[1][varType]}{form[1][annotated]}.txt", outputDIR=config["outputDIR"], vcfAnnotateDIR=config["vcfAnnotateDIR"], vcfProgram=config["vcfProgram"],  form=read_table(StringIO(config["sampleFORM"]), " ").iterrows()),\n'
        '#-----------------------------------------------------------------------------------------------------------------------------------------------------\n'
    )
#-----------------------------------------------------------------------------------------------------------------------------------------------------
