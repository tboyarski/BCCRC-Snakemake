...
with open(sys.argv[1], "a+") as yamlTARGET:
    # 2A. Software
    mPileSPLIT_samtoolsProg = "mPileSPLIT_samtoolsProg: samtools\n"
    mPileUNSPLIT_samtoolsProg = "mPileUNSPLIT_samtoolsProg: samtools\n"
    # 2B. Shared variables
    mpileDIR="mpileDIR: mPile\n"
    bitFLAG="bitFLAG: 512\n"
